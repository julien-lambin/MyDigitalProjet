...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 05 juin 2021 à 08:54
...
INSERT INTO `commandes` (`num_Commande`, `email_Client`, `email_reparateur`, `categorie`, `marque`, `reference`, `description`, `etat`, `date_creation`) VALUES
...
(5, 'aa', 'LAMBIN', 'Julien', 'julien59155@gmail.com', 750415911, '7 RUE DU MARECHAL FOCH', 'FACHES THUMESNIL', '59155', '$2y$10$k/CiGje8rvMYzq7/AirhNeG.JsJX8ZAracYffDpXbgOF07kiCtrgS', 'Smartphone', 123, 'logo.PNG', 'logoJL - Copie.PNG', 'pp_pro_default', 0, 1, 5, 0, '28/05/2021', '0.002770905492330529'),
